...
import 'package:e_commerce/widgets/home_widgets/add_to_cart.dart';
...
class Details extends StatelessWidget {
  ...
  const Details({Key? key, required this.catelog}) : super(key: key);
  @override
      ...
      bottomNavigationBar: Container(
        ...
        child: SafeArea(
          child: ButtonBar(
            ...
            children: [
              '₹${catelog.price}'.text.bold.xl4.black.make(),
              AddToCart(
                catelog: catelog,
              ).wh(150, 50)
            ],
